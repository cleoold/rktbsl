...
;; recursive-sequence1: X (X Nat -> X) -> (Nat -> X)
...
;(build-list 10 (recursive-sequence1 1 (λ (x n) (* 2 x)))) -> '(1 2 4 8 16 32 64 128 256 512)
...
;; recursive-sequence2: X X (X X Nat -> X) -> (Nat -> X)
...
;(build-list 7 (recursive-sequence2 1 1 (λ (x y n) (+ x (sqr y))))) -> '(1 1 2 5 27 734 538783)
